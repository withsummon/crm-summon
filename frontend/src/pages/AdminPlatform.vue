...
const featureCards = [
  ...
  { key: 'workflow', label: 'Workflow Engine', desc: 'No-code drag-drop workflow builder', icon: 'git-merge', gradient: 'linear-gradient(135deg, #059669, #34d399)', stat: '8 active workflows', route: '/lending-risk/workflow-engine' },
