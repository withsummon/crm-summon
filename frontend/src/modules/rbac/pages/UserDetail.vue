      ...
      <div class="mx-auto max-w-4xl p-6 space-y-6">
        ...
        <div class="rounded-[18px] bg-white p-6 shadow-sm border border-crm-border">
          <h2 class="mb-4 text-base font-semibold text-crm-text flex items-center gap-2">
            <LucideUser class="h-4 w-4 text-primary-600" />
        ...
        <div class="rounded-[18px] bg-white p-6 shadow-sm border border-crm-border">
          ...
          <div class="mb-4 relative">
            ...
            <input
              ...
              class="h-9 w-full rounded-[10px] border border-crm-border bg-crm-surface-light pl-9 pr-4 text-sm outline-none focus:border-primary-600 focus:ring-2 focus:ring-primary-600/20"
            />
          </div>
            ...
            <label
              ...
              :class="
                userRoleNames.includes(role.name)
                  ? 'border-primary-600/40 bg-crm-surface'
                  : 'border-crm-border hover:border-crm-primary-light hover:bg-crm-surface-light'
              "
            >
              <input
                type="checkbox"
                ...
                class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-600/30"
              />
